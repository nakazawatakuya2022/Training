...
IF NOT EXISTS (
    ...
    WHERE name = 'PandaPharmacyAdvanced'
)
BEGIN
    CREATE DATABASE PandaPharmacyAdvanced;
END
GO

USE PandaPharmacyAdvanced
GO
...
CREATE TABLE order_archives (
  ...
  , product_id int NOT NULL
  , quantity int NOT NULL
  , CONSTRAINT order_archives_PKC PRIMARY KEY (order_id)
) ;
...
EXECUTE sp_addextendedproperty N'MS_Description', N'過去の注文テーブル', N'SCHEMA', N'dbo', N'TABLE', N'order_archives', NULL, NULL;
EXECUTE sp_addextendedproperty N'MS_Description', N'注文ID', N'SCHEMA', N'dbo', N'TABLE', N'order_archives', N'COLUMN', N'order_id';
EXECUTE sp_addextendedproperty N'MS_Description', N'注文日', N'SCHEMA', N'dbo', N'TABLE', N'order_archives', N'COLUMN', N'order_date';
EXECUTE sp_addextendedproperty N'MS_Description', N'顧客番号', N'SCHEMA', N'dbo', N'TABLE', N'order_archives', N'COLUMN', N'customer_no';
EXECUTE sp_addextendedproperty N'MS_Description', N'商品ID', N'SCHEMA', N'dbo', N'TABLE', N'order_archives', N'COLUMN', N'product_id';
EXECUTE sp_addextendedproperty N'MS_Description', N'数量', N'SCHEMA', N'dbo', N'TABLE', N'order_archives', N'COLUMN', N'quantity';
...
INSERT INTO products (product_name, price, memo, category_id) VALUES ('歯ブラシ', 280, '歯ぐきを傷めないやわらかめの歯ブラシです。', 6)

INSERT INTO order_archives (order_date, customer_no, product_id, quantity) VALUES
('2025-03-01', '000001', 1, 5),
('2025-03-02', '000002', 2, 3),
('2025-03-03', '000007', 1, 8),
('2025-03-04', '000006', 6, 2),
('2025-03-05', '000003', 5, 1),
('2025-03-06', '000006', 6, 6),
('2025-03-07', '000007', 5, 7),
('2025-03-08', '000001', 8, 4),
('2025-03-09', '000009', 6, 2),
('2025-03-10', '000010', 10, 5),
('2025-03-11', '000003', 1, 3),
('2025-03-12', '000005', 2, 6),
('2025-03-13', '000001', 3, 4),
('2025-03-14', '000010', 4, 8),
('2025-03-15', '000006', 3, 2),
('2025-03-16', '000008', 10, 1),
('2025-03-17', '000002', 7, 5),
('2025-03-18', '000009', 4, 3),
('2025-03-19', '000007', 9, 7),
('2025-03-20', '000004', 5, 4),
('2025-03-21', '000010', 1, 2),
('2025-03-22', '000002', 4, 5),
('2025-03-23', '000007', 2, 1),
('2025-03-24', '000004', 6, 9),
('2025-03-25', '000007', 5, 3),
('2025-03-26', '000001', 3, 4),
('2025-03-27', '000006', 8, 6),
('2025-03-28', '000003', 8, 2),
('2025-03-29', '000008', 9, 5),
('2025-03-30', '000005', 10, 10),
('2025-04-01', '000001', 2, 5),
('2025-04-02', '000002', 3, 3),
('2025-04-03', '000003', 4, 10),
('2025-04-04', '000004', 5, 2),
('2025-04-05', '000005', 6, 1),
('2025-04-06', '000006', 7, 6),
('2025-04-07', '000007', 8, 8),
('2025-04-08', '000008', 9, 4),
('2025-04-09', '000009', 10, 2),
('2025-04-10', '000010', 1, 7),
('2025-04-11', '000001', 3, 5),
('2025-04-12', '000002', 4, 3),
('2025-04-13', '000003', 5, 10),
('2025-04-14', '000004', 6, 2),
('2025-04-15', '000005', 7, 1),
('2025-04-16', '000006', 8, 6),
('2025-04-17', '000007', 9, 8),
('2025-04-18', '000008', 10, 4),
('2025-04-19', '000009', 1, 2),
('2025-04-20', '000010', 2, 7),
('2025-04-21', '000001', 4, 5),
('2025-04-22', '000002', 5, 3),
('2025-04-23', '000003', 6, 10),
('2025-04-24', '000004', 7, 2),
('2025-04-25', '000005', 8, 1),
('2025-04-26', '000006', 9, 6),
('2025-04-27', '000007', 10, 8),
('2025-04-28', '000008', 1, 4),
('2025-04-29', '000009', 2, 2),
('2025-04-30', '000010', 3, 7);

INSERT INTO orders (order_date, customer_no, product_id, quantity) VALUES
('2025-05-01', '000001', 1, 1),
('2025-05-02', '000001', 4, 2),
('2025-05-03', '000001', 7, 3),
('2025-05-04', '000004', 7, 2),
('2025-05-05', '000005', 8, 1),
('2025-05-05', '000005', 1, 3),
('2025-05-06', '000006', 9, 6),
('2025-05-08', '000012', 5, 4);
